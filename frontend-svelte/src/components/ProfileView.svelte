    ...
    >
      ...
      <div style="padding: 24px; display: flex; flex-direction: column; gap: 16px;">
        ...
        <div style="border: 1.5px solid #e2e8f0; border-radius: 12px; padding: 16px; display: flex; align-items: center; justify-content: space-between; gap: 14px; background: #f8fafc;">
          ...
          <button 
            type="button"
            on:click={() => handleDownloadApp(toBackendUrl('/api/downloads/' + androidFile), androidFile, 'application/vnd.android.package-archive')}
            style="display: inline-flex; align-items: center; gap: 6px; background: #10b981; color: #ffffff; padding: 9px 15px; border-radius: 8px; font-weight: 700; font-size: 12.5px; border: none; cursor: pointer; box-shadow: 0 2px 6px rgba(16,185,129,0.3); transition: all 0.15s ease; white-space: nowrap;">
        ...
        <div style="border: 1.5px solid #e2e8f0; border-radius: 12px; padding: 16px; display: flex; align-items: center; justify-content: space-between; gap: 14px; background: #f8fafc;">
          ...
          <button 
            type="button"
            on:click={() => handleDownloadApp(toBackendUrl('/api/downloads/' + windowsFile), windowsFile, 'application/vnd.microsoft.portable-executable')}
            style="display: inline-flex; align-items: center; gap: 6px; background: #2563eb; color: #ffffff; padding: 9px 15px; border-radius: 8px; font-weight: 700; font-size: 12.5px; border: none; cursor: pointer; box-shadow: 0 2px 6px rgba(37,99,235,0.3); transition: all 0.15s ease; white-space: nowrap;">
            <span class="material-icons" style="font-size: 18px;">download</span>
            <span>Descargar</span>
          </button>
        </div>
