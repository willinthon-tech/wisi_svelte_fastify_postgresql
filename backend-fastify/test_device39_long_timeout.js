...
async function testLongTimeout() {
  console.log(`📡 Querying DS-K1T343MWX (192.168.3.174) with 60s timeout...`);
  ...
  try {
    ...
    if (www && www.includes('Digest')) {
      ...
      console.log(`   Sending Digest request... Waiting for DS-K1T343MWX database response...`);
      ...
      console.log(`🎉 SUCCESS for DS-K1T343MWX! Status: ${res2.status} in ${Date.now() - start}ms`);
