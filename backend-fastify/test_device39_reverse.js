...
async function testReverse() {
  console.log(`\nTesting DS-K1T343MWX (192.168.3.174) with timeReverseOrder: "true"...`);
  ...
  try {
    ...
    if (www && www.includes('Digest')) {
      ...
      console.log(`🎉 SUCCESS for timeReverseOrder! Status: ${res2.status} in ${Date.now() - start}ms`);
      console.log(`   Response text:`, text.substring(0, 600));
      return true;
    }
  } catch (e) {
    console.log(`❌ Error for timeReverseOrder:`, e.message);
  }
  return false;
}
