...
async function testWithPicEnable(label, acsCond) {
  ...
  const bodyStr = JSON.stringify({ AcsEventCond: acsCond });
...
async function runAll() {
  await testWithPicEnable("picEnable: true with searchID 1 maxResults 10", {
    searchID: "1",
  ...
  await testWithPicEnable("picEnable: false with searchID 1 maxResults 10", {
    searchID: "1",
    searchResultPosition: 0,
    maxResults: 10,
    major: 5,
