...
export let inMemoryData = {
  ...
  modulos: [
    ...
    { id: 23, nombre: 'Máquinas', icono: 'settings', ruta: '/configuracion/maquinas', page_id: 3 },
    ...
    { id: 21, nombre: 'Modos', icono: 'settings', ruta: '/configuracion/modos', page_id: 3 },
  ...
  try {
    ...
    if (userCount[0].count === 0) {
      ...
      await sql`
        ...
        (23, 'Máquinas', 'settings', '/configuracion/maquinas', 3),
        ...
        (21, 'Modos', 'settings', '/configuracion/modos', 3),
        (22, 'Legal', 'settings', '/configuracion/legal', 3),
        (12, 'Mesas', 'settings', '/mesas-en-vivo/mesas', 7),
        (34, 'Juegos', 'settings', '/configuracion/juegos', 7),
