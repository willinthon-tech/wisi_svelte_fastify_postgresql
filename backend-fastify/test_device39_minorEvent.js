...
async function testMinorEvent(label, bodyObj) {
  ...
  const bodyStr = JSON.stringify({ AcsEventCond: bodyObj });
...
async function runAll() {
  // Test 1: minorEvent: 0
  await testMinorEvent("major: 5, minorEvent: 0, maxResults: 10", {
    searchID: "1",
  ...
  // Test 2: minorEvent: 75 (Access Granted)
  await testMinorEvent("major: 5, minorEvent: 75, maxResults: 10", {
    searchID: "1",
    searchResultPosition: 0,
    maxResults: 10,
    major: 5,
  ...
  // Test 3: both minor: 0 and minorEvent: 0
  await testMinorEvent("major: 5, minor: 0, minorEvent: 0, maxResults: 10", {
    searchID: "1",
    searchResultPosition: 0,
    maxResults: 10,
    major: 5,
